<?php $__env->startSection('title', 'Tambah Data Pekerjaan'); ?>
        ...
        <form action="<?php echo e(route('program.store')); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="program_id" id="program_id" class="form-control select2" style="width: 100%;">
                    ...
                    <?php $__currentLoopData = $keg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($item->id); ?>"><?php echo e($item->program); ?> - <?php echo e($item->sub_kegiatan); ?></option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_pekerjaan" name="nama_pekerjaan" placeholder="Input nama pekerjaan">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pagu" name="pagu" data-type="currency" id="currency-field" placeholder="Input Pagu">
            </div>
            <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/ams/resources/views/halaman/pekerjaan/tambah.blade.php ENDPATH**/ ?>