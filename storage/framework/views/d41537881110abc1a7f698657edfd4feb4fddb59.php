		...
		<nav class="sidebar-main">
			...
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
					...
					<?php endif; ?>
					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/wilayah' ? 'active' : ''); ?>" href="#"><i data-feather="airplay"></i><span class="lan-6">Data Wilayah</span>
							<div class="according-menu"><i class="fa fa-angle-<?php echo e(request()->route()->getPrefix() == '/wilayah' ? 'down' : 'right'); ?>"></i></div>
						</a>
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->route()->getPrefix() == '/wilayah' ? 'block;' : 'none;'); ?>">
							<li><a href="/wilayah/kecamatan" class="<?php echo e(request()->route()->getPrefix()=='wilayah' ? 'active' : ''); ?>">Kecamatan</a></li>
						</ul>
					</li>
					<li class="sidebar-main-title">
						<div>
...
</div><?php /**PATH D:\repo\sandb\resources\views/layouts/simple/sidebar.blade.php ENDPATH**/ ?>