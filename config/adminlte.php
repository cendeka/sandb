        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://adminlte.io/themes/v3/plugins/datatables-buttons/js/buttons.html5.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://adminlte.io/themes/v3/plugins/datatables-buttons/js/buttons.print.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://adminlte.io/themes/v3/plugins/datatables-buttons/js/buttons.colVis.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://adminlte.io/themes/v3/plugins/pdfmake/pdfmake.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://adminlte.io/themes/v3/plugins/pdfmake/vfs_fonts.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
        ...
        'Select2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://adminlte.io/themes/v3/plugins/select2/js/select2.full.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'https://adminlte.io/themes/v3/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'https://adminlte.io/themes/v3/plugins/select2/css/select2.min.css',
                ],
            ],
        ],
        'Chartjs' => [
        ...
        'Sweetalert2' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://adminlte.io/themes/v3/plugins/toastr/toastr.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
        ...
        'Dropzone' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/dropzone/dist/dropzone.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/dropzone/dist/dropzone.js',
                ],
            ],
        ],
    ],
