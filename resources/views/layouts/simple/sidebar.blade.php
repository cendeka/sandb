<div class="sidebar-wrapper">
	<div>
		...
		<div class="logo-icon-wrapper"><a href="{{route('/')}}"><img class="img-fluid" src="{{asset('assets/images/logo/logo-icon.png')}}" style="height: 50px;" alt=""></a></div>
		<nav class="sidebar-main">
			<div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
					<li class="back-btn">
						<a href="{{route('/')}}"><img class="img-fluid" src="{{asset('assets/images/logo/logo-icon.png')}}" style="height: 50px;" alt=""></a>
					...
					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{Route::currentRouteName()=='rincian' ? 'active' : ''  }}" href="{{route('rincian')}}"><i data-feather="layers"></i><span class="lan-3">Rincian Kegiatan</span></a>
					</li>
					<li class="sidebar-list">
